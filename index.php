...
<table width="90%" border="0"  cellspacing="0" cellpadding="0" align="center" style="background:url(images/bodybg.jpg) repeat-x;">
  ...
  <tr>
	...
	<li><a href="Agent.php">Agent Contact</a></li>
	<!--<li><a href="">Home</a></li>-->
	</ul>
	</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
	<td colspan="2" align="center"><input type="submit" name="login" value="Login" class="greenButton" />
	<a href="reg.php" class="a">Sign up</a></td>
	</tr>
	</table>
	</form>
	<?php
  ...
  <?php
   ...
   {
    $_SESSION["id"]=$row['id']; //echo $_SESSION["cusid"];
 ...
 {
  echo "<center><font color=red><b>Invalid Login!!</b>";
 }
	...
	<tr><td><img src="images/smallbus.JPG" /></td></tr>
	<tr align="center"><td colspan="1"><a href="trips1.php"><img src="images/btn_search.gif"  style="border:none;"/></a></td></tr></table>
