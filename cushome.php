...
<table width="90%" border="0"  cellspacing="0" cellpadding="0" align="center" style="background:url(images/bodybg.jpg) repeat-x;">
  ...
  <tr>
	...
	<table width="92%" height="273" border="0"  align="center">
	<tr><td height="140" class='label'>Profile Options</td>
		<td><a href="edit.php?id=<?php echo $_SESSION["id"]; ?>" class="a">Edit Profile</a></td>
		<td><a href="pass.php?id=<?php echo $_SESSION["id"]; ?>" class="a">Change Password</a></td>
		<?php //echo $_SESSION["id"]; ?>
	</tr>
    <tr><td colspan="3" valign="top">
    <table align="center" border="0">
	<tr><td><img src="images/smallbus.JPG" /></td></tr>
	<tr align="center"><td><a href="trips.php"><img src="images/btn_search.gif"  style="border:none;"/></a></td></tr></table>
    </td></tr>
    </table>
	</form>
